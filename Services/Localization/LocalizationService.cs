...
public sealed class LocalizationService
{
    ...
    private void LoadFallbackStrings()
    {
        ...
        _fallbackStrings["AICodeFormatMismatch"] = "The generated code targets a different format, so it was not applied (switch back to the tab it was generated for)";
        ...
        _fallbackStrings["FormatMermaid"] = "Mermaid";
        _fallbackStrings["FormatDot"] = "Graphviz DOT";
        ...
        _fallbackStrings["FileTypeAllSupported"] = "All supported formats";
        _fallbackStrings["FileTypeAllFiles"] = "All files";
        _fallbackStrings["OpenFileDialogTitle"] = "Open diagram file";
        _fallbackStrings["SaveFileDialogTitle"] = "Save diagram file";
        _fallbackStrings["LayoutLabel"] = "_Layout";
        _fallbackStrings["DotRendererMissing"] = "Graphviz renderer assets are missing (tools\\graphviz\\graphviz.js). Run tools\\fetch-graphviz.ps1 first, or reinstall the app.";
